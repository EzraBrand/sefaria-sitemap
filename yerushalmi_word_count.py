...
# List of some Yerushalmi tractates (add more as needed)
...
def count_hebrew_words(text):
    # Remove non-Hebrew characters, split by whitespace
...
def get_tractate_hebrew_word_count(tractate):
    ...
    try:
        ...
        data = resp.json()
        # Sefaria returns text as nested lists (chapters, sections)
...
def main():
    print("Yerushalmi Hebrew Word Count per Tractate:")
